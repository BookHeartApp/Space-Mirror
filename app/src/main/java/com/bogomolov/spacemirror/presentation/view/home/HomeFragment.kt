package com.bogomolov.spacemirror.presentation.view.home
...
import com.bogomolov.spacemirror.databinding.FragmentHomeBinding
import com.bogomolov.spacemirror.presentation.viewmodel.apod.APODState
import com.bogomolov.spacemirror.presentation.viewmodel.apod.APODViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        activity?.let {
            binding.apodCopyrightTextView.typeface =
                Typeface.createFromAsset(it.assets, "Lovelo_Line_Bold.otf")
        }
    }
